### This code using AF2bind (https://github.com/artemg97/af2bind_prod) to predict the binding residues. 
### The grid box is calulated based on the binding residues.

"""
Please download the following parameters to be able to use the AF2bind locally:
